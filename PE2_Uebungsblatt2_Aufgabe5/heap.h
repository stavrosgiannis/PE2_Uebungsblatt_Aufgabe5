...
/**
 * @brief Hilfsfunktion, um den Index des parent knotens von einem gegebenen Knoten i zu errechnen
 * @param i Index des Knotens
 * @return int Array-Index, des parent knotens
 */
int parent(int i) {
	return (i - 1) / 2;
}
...
/**
 * @brief Hilfsfunktion, um den Index des Linken Kindsknoten eines parent knotens i zu errechnen
 * @param i Index des Knotens
...
/**
 * @brief Hilfsfunktion, um den Index des rechten Kindsknoten eines parent knotens i zu errechnen
 * @param i Index des Knotens
